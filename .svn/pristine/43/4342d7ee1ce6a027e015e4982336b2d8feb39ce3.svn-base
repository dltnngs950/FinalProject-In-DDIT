                   ...
                   <div class="col-md-3 col-sm-6">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="dashboard-tile detail tile-purple">
                            <div class="content">
                                <h1 class="text-left timer" data-to="${pmsList.size()}" data-speed="500">${pmsList.size()}</h1>
                                <p>진행중인 프로젝트</p>
                            </div>
...
<div class="panel-heading">
    <h3 class="panel-title">${bor_nm}</h3>
   	<div class="actions pull-right">
                                    <a href="${cp}/board/postListView?bor_no=-1"><i>더보기</i></a>
                                </div>
</div>
...
<div class="panel-heading">
    ...
    <div class="actions pull-right">
        <a href="${cp}/app/appView"><i>더보기</i></a>
    </div>
...
<div class="panel-heading">
			...
			<div class="actions pull-right">
                                    <a href="${cp}/pms/main?attend_emp_no=${S_USER.emp_no}"><i>더보기</i></a>
                                </div>
		</div>
...
<div class="panel-heading">
			...
			<div class="actions pull-right">
                                    <a href="${cp}/scd/calendar?emp_no=${S_USER.emp_no}&dept_no=${S_USER.dept_no}"><i>더보기</i></a>
                                </div>
		</div>
