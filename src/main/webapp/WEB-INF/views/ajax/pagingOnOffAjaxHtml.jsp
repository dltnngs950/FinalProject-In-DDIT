<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<c:choose>
		...
		<c:forEach items="${onofflist}" var="onoff">
			...
			onClick="window.open('/empController/onoffDetail?emp_no=${onoff.emp_no}&emp_id=${onoff.emp_id }','근태 상세조회','width=890, height=950, toolbar=no, menubar=no, scrollbars=no, resizable=yes');return false;">
<%-- 				<td>${onoff.emp_no}</td> --%>
